...
Or if you use Rails 4 rc:

  gem "inherited_resources", github: "josevalim/inherited_resources", ref: "2c57b0566e"
  gem 'devise', github: 'plataformatec/devise', branch: :rails4
  gem 'formtastic', github: 'justinfrench/formtastic', branch: "rails4beta"
  gem 'activeadmin', github: 'gussan/active_admin', branch: :rails4
...
== Precompile problem on Rails4.0 beta

sprockets-rails has a problem with asset_paths.
* https://github.com/rails/sprockets-rails/pull/36

To solve this, add below line to `config/application.rb`:
